...
<div style="display: flex; flex-wrap: wrap; gap: 10px;">
  <div style="background-color: #FFA500; color: black; padding: 10px 20px; border-radius: 5px; font-weight: bold;">Rashi</div>
  <div style="background-color: #00CED1; color: white; padding: 10px 20px; border-radius: 5px; font-weight: bold;">Sadaf</div>
  <div style="background-color: #ADFF2F; color: black; padding: 10px 20px; border-radius: 5px; font-weight: bold;">Daniel</div>
  <div style="background-color: #FF69B4; color: white; padding: 10px 20px; border-radius: 5px; font-weight: bold;">Aadi</div>
  <div style="background-color: #8A2BE2; color: white; padding: 10px 20px; border-radius: 5px; font-weight: bold;">Sujay</div>
  <div style="background-color: #1E90FF; color: white; padding: 10px 20px; border-radius: 5px; font-weight: bold;">Arjun</div>
</div>
